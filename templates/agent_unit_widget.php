...
if($agent_wid!=0){
    ...
    $name               = wpresidence_get_sanitized_truncated_title($agent_wid,0);
...
?>
    ...
    <div class="agent_unit agent_unit_sidebar" data-link="<?php print esc_attr($link);?>">
        ...
        <div class="">
            ...
            if ($agent_email) {
                $email_display = antispambot($agent_email);
                $email_link    = antispambot(esc_attr($agent_email));
                print '<div class="agent_detail"><i class="far fa-envelope"></i> <a href="mailto:'. $email_link .'">'. $email_display . '</a></div>';
            }
