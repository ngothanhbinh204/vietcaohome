...
<?php if ($prop_selection->have_posts()) : ?>
    <div class="wpresidence_realtor_listings_wrapper developer_listing agency_listings_title single_listing_block">
        <div class="term_bar_wrapper agency_listings mx-0 d-flex flex-column flex-md-row" data-agency_id="<?php echo esc_attr($user_agency); ?>" data-post_id="<?php echo esc_attr($post->ID); ?>">
