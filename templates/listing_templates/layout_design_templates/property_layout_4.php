<?php
/** MILLDONE
 * WpResidence Theme - Property Layout 4 Template
 * src templates/listing_templates/layout_design_templates/property_layout_4.php
 * This file contains the layout structure for property layout 4 in the WpResidence theme.
 * It includes breadcrumbs, title section, media, overview, content, and sidebar.
 *
 * @package WpResidence
 ...
 * a property page with layout 4 selected.
 */
...
?>
    ...
    <div class=" wpresidence-content-container-wrapper col-12 d-flex flex-wrap wpresidence_property_layout4"><!-- START ROW container -->
        ...
        <div class="wpestate_lay3_media_wrapper col-12 col-md-12">
            ...
            wpestate_property_page_load_media($post->ID, $wpestate_options, 4);
