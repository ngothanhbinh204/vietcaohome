 ...
 * src: templates\dashboard-templates\change_pass_template.php
 * Displays the password change form in the WpEstate dashboard.
 * Updated for Bootstrap 5.3 with improved validation and accessibility.
 * 
 * @package WpResidence
